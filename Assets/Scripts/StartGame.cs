...
public class StartGame : MonoBehaviour {
	...
	void Create_Level(){
		...
		Create_Room (pos, 2); //Creates room with initial Position.
	...
	void Create_Room(Vector3 pos, int min){
		...
		int[] currentdoors = new int[num_Of_Doors]; //Creates a array of the doors in the room.
		int counter = 0; //Sets a ccounter for the doors.
	...
	void Create_Door(int direction, Vector3 pos){
		...
		if (direction == 1) {
			...
			Create_Room (new Vector3(pos.x + 8f, pos.y, pos.z), 0); //Create a room to the Right.
		}
		else if (direction == 2) {
			...
			Create_Room (new Vector3(pos.x - 8f, pos.y, pos.z), 0);//Create a room to the Left.
		}
		else if (direction == 3) {
			...
			Create_Room (new Vector3(pos.x , pos.y + 4.55f, pos.z), 0);//Create a room upwards.
		}
		else if (direction == 4) {
			...
			Create_Room (new Vector3(pos.x, pos.y - 4.55f, pos.z), 0);//Create a room at the bottom.
		}
	}
	//Creates new level.
